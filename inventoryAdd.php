...
<table width="605" border="1" align="center" cellpadding="3">
  ...
  <tr>
    ...
    <td><input type="number" id="new-part-price" name="new-part-price" placeholder="ex: 44.99" required min="1" step="0.1"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="number" id="new-part-quantity" name="new-part-quantity" placeholder="ex: 15" required min="1"></td>
  </tr>
</table>
<br>
